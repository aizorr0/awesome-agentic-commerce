...
- [Verathos](https://verathos.ai) – OpenAI-compatible LLM inference on Bittensor with cryptographically verified model weights; pay per request in USDC on Base via x402, no account needed. ([Agent quickstart](https://verathos.ai/skill.txt))
